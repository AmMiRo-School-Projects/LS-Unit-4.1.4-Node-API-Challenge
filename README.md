...
- [x] Mention two parts of Express that you learned about this week.
  ...
  - The two parts of Express that I learned about this week are the server-side-router and middleware.

- [x] Describe Middleware?

  - Middleware is a function that interacts with data flowing through the api. It could be to record, manipulate, or respond to that data

- [x] Describe a Resource?

  - A Resource is any type of data that the client may want to acceess.

- [x] What can the API return to help clients know if a request was successful?

  - The API can return a status with the response that indicates a successful request.

- [x] How can we partition our application into sub-applications?

  - Our application can be partitioned by creating files for routing, etc. that are specific to a resource.
